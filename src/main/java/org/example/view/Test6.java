...
////        drawerMenu.add(createNavButton("chart-bar", "Thống kê", false, Test7::createDashboardPanel));
////        drawerMenu.add(Box.createVerticalStrut(8));
////        drawerMenu.add(createNavButton("logout", "Đăng xuất", false, null));
//
//        drawerMenu.add(Box.createVerticalStrut(20));
//
//        // Các nút chức năng chính - căn trái theo LEFT_PADDING
//        drawerMenu.add(createNavButton("home", "Trang chủ", false, Test8::createDashboardPanel));
//        drawerMenu.add(Box.createVerticalStrut(8));
//        drawerMenu.add(createNavButton("magnify", "Tìm kiếm", false, Test9::createSearchPanel));
//        drawerMenu.add(Box.createVerticalStrut(8));
//        drawerMenu.add(createNavButton("calendar-check", "Đặt phòng", false, Test9::createSearchPanel));
//        drawerMenu.add(Box.createVerticalStrut(8));
//        drawerMenu.add(createNavButton("bed-outline", "Phòng nghỉ", false, Test9::createSearchPanel));
//        drawerMenu.add(Box.createVerticalStrut(8));
//        drawerMenu.add(createNavButton("account-multiple", "Khách hàng", false, Test9::createSearchPanel));
//        drawerMenu.add(Box.createVerticalStrut(8));
//        drawerMenu.add(createNavButton("clipboard-check", "Yêu cầu", false, Test9::createSearchPanel));
//        drawerMenu.add(Box.createVerticalStrut(8));
//        drawerMenu.add(createNavButton("chart-bar", "Thống kê", false, Test7::createDashboardPanel));
//
...
//            e.printStackTrace();
//        }
//        SwingUtilities.invokeLater(() -> new Test6().setVisible(true));
//    }
//}
...
public class Test6 extends JFrame {
    ...
    public Test6() {
        ...
        drawerMenu.add(createNavButton("magnify", "Tìm kiếm", false, Test9::createSearchPanel));
        drawerMenu.add(Box.createVerticalStrut(8));
        drawerMenu.add(createNavButton("calendar-check", "Đặt phòng", false, Test15::createBookingPanel));
        drawerMenu.add(Box.createVerticalStrut(8));
        drawerMenu.add(createNavButton("bed-outline", "Phòng nghỉ", false, Test14::createRoomSearchPanel));
        drawerMenu.add(Box.createVerticalStrut(8));
        drawerMenu.add(createNavButton("account-multiple", "Khách hàng", false, Test13::createCustomerSearchPanel));
        drawerMenu.add(Box.createVerticalStrut(8));
        drawerMenu.add(createNavButton("clipboard-check", "Yêu cầu", false, Test12::createNotificationPanel));
        drawerMenu.add(Box.createVerticalStrut(8));
        drawerMenu.add(createNavButton("chart-bar", "Thống kê", false, Test7::createDashboardPanel));
        ...
        // ✅ Hiển thị giao diện Trang chủ mặc định
        mainContentPanel.add(Test8.createDashboardPanel(), BorderLayout.CENTER);
        mainContentPanel.revalidate();
        mainContentPanel.repaint();

        // ✅ Tô màu nút "Trang chủ" là đã chọn
