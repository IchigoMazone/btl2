...
public class CustomerView {
    ...
    public static JPanel createCustomerSearchPanel(CustomerController controller) {
        JPanel panel = new JPanel(new BorderLayout(10, 10));
        panel.setBackground(Color.WHITE);
        ...
        btnTimKiem.addActionListener(e -> controller.handleSearch(panel, cbTieuChi, tfTuKhoa));

        btnThem.addActionListener(e -> controller.handleAdd(panel, tableModel));
        btnXoa.addActionListener(e -> controller.handleDelete(panel, tableModel, table));
        btnSua.addActionListener(e -> controller.handleEdit(panel, tableModel, table));
