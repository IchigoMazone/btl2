...
public class AdminBookingView {
    ...
    public static JPanel createBookingPanel(MainFrameView mainFrame, SelectedRoomInfo selectedRoom) {
        ...
        AdminBookingController controller = new AdminBookingController(mainFrame, selectedRoom);
        ...
        // Initialize số người listener after form is created
        cbSoNguoi.addActionListener(e -> controller.handleSoNguoiChange());

        return panel;
    }

    private static JPanel createFormPanel(AdminBookingController controller) {
        JPanel formPanel = new JPanel(new GridBagLayout());
        formPanel.setBackground(UIManager.getColor("Panel.background"));
        formPanel.setBorder(BorderFactory.createTitledBorder(
                BorderFactory.createLineBorder(new Color(180, 180, 180)),
        ...
        gbc.gridwidth = 1;
        JButton btnRandom = new JButton("Sinh ngẫu nhiên");
        btnRandom.addActionListener(e -> controller.handleRandomUsername());
        formPanel.add(btnRandom, gbc);
    ...
    private static JPanel createButtonPanel(MainFrameView mainFrame, AdminBookingController controller) {
        JPanel btnPanel = new JPanel(new FlowLayout(FlowLayout.RIGHT));
        btnPanel.setBackground(UIManager.getColor("Panel.background"));
    ...
    public static JTextField getTfTaiKhoan() {
        return tfTaiKhoan;
    }

    public static JTextField getTfSdt() {
        return tfSdt;
    }

    public static JTextField getTfGmail() {
        return tfGmail;
    }
