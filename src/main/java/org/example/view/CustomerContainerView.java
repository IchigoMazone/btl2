...
//////        setDynamicContent(CustomerDashboardView.createUserHomePanel());
//////
//////        // Chọn nút Trang chủ làm mặc định
...
//////    public void loadData(String username) {
//////        this.username = username;
//////        // Nếu cần load thêm dữ liệu thì xử lý tại đây
//////    }
//////}
////
////
...
//
//        drawerMenu.add(createNavButton("calendar-check", "Lịch sử", false,
//                () -> HistoryView.createPaymentHistoryPanel(username)));
//        drawerMenu.add(Box.createVerticalStrut(8));
//
//        // === Logout ===
//        drawerMenu.add(Box.createVerticalGlue());
...
//
//    public void loadData(String username) {
//        // Không gán lại username vì nó là final
//        // Nếu cần tải dữ liệu bổ sung dựa trên username, xử lý tại đây
//        setDynamicContent(CustomerDashboardView.createUserHomePanel());
//    }
//}
