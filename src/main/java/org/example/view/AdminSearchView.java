...
public class AdminSearchView {
    ...
    private JComboBox<Integer> cbHourIn;
    private JComboBox<Integer> cbMinIn;
    private JComboBox<Integer> cbHourOut;
    private JComboBox<Integer> cbMinOut;
    ...
    private AdminSearchView() {
        initializeComponents();
    }

    public static JPanel createSearchPanel(MainFrameView mainFrame) {
        AdminSearchView view = new AdminSearchView();
        AdminSearchController controller = new AdminSearchController(view, mainFrame);
    ...
    private void initializeComponents() {
        ...
        DatePickerSettings inSettings = new DatePickerSettings();
        inSettings.setFormatForDatesCommonEra("dd-MM-yyyy");
        dpIn = new DatePicker(inSettings);

        DatePickerSettings outSettings = new DatePickerSettings();
        outSettings.setFormatForDatesCommonEra("dd-MM-yyyy");
        dpOut = new DatePicker(outSettings);
        ...
        cbHourIn = new JComboBox<>(hours);
        cbMinIn = new JComboBox<>(mins);
        cbHourOut = new JComboBox<>(hours);
        cbMinOut = new JComboBox<>(mins);
    ...
    public DatePicker getDpIn() {
        return dpIn;
    }

    public DatePicker getDpOut() {
        return dpOut;
    }

    public JComboBox<Integer> getCbHourIn() {
        return cbHourIn;
    }

    public JComboBox<Integer> getCbMinIn() {
        return cbMinIn;
    }

    public JComboBox<Integer> getCbHourOut() {
        return cbHourOut;
    }

    public JComboBox<Integer> getCbMinOut() {
        return cbMinOut;
    }
