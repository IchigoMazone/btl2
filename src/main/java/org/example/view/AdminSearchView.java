...
public class AdminSearchView {
    ...
    public static JPanel createSearchPanel(MainFrameView mainFrame) {
        ...
        RoomFinderService finder = new RoomFinderService("rooms.xml", "bookings.xml");
        AdminSearchController controller = new AdminSearchController(
                mainFrame, panel, table, tableModel, dpIn, dpOut,
                cbHourIn, cbMinIn, cbHourOut, cbMinOut, cbType, finder
        );
        btnSearch.addActionListener(controller::handleSearchAction);
        btnBook.addActionListener(controller::handleBookAction);
