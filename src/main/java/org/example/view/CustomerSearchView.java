...
public class CustomerSearchView {
    ...
    private JComboBox<Integer> cbCheckInHour;
    private JComboBox<Integer> cbCheckInMinute;
    private JComboBox<Integer> cbCheckOutHour;
    private JComboBox<Integer> cbCheckOutMinute;
    ...
    private CustomerSearchView() {
        initializeComponents();
    }

    public static JPanel createSearchPanel(MainFrameView mainFrame) {
        CustomerSearchView view = new CustomerSearchView();
        CustomerSearchController controller = new CustomerSearchController(view, mainFrame);
    ...
    public DatePicker getDpCheckIn() {
        return dpCheckIn;
    }

    public DatePicker getDpCheckOut() {
        return dpCheckOut;
    }

    public JComboBox<Integer> getCbCheckInHour() {
        return cbCheckInHour;
    }

    public JComboBox<Integer> getCbCheckInMinute() {
        return cbCheckInMinute;
    }

    public JComboBox<Integer> getCbCheckOutHour() {
        return cbCheckOutHour;
    }

    public JComboBox<Integer> getCbCheckOutMinute() {
        return cbCheckOutMinute;
    }

    public JComboBox<String> getCbLoaiPhong() {
        return cbLoaiPhong;
    }
