...
public class CustomerSearchView {
    ...
    public static JPanel createSearchPanel(MainFrameView mainFrame) {
        ...
        // === Khởi tạo controller và gắn sự kiện ===
        RoomFinderService finder = new RoomFinderService("rooms.xml", "bookings.xml");
        CustomerSearchController controller = new CustomerSearchController(
                mainFrame, panel, table, tableModel, dpCheckIn, dpCheckOut,
                cbCheckInHour, cbCheckInMinute, cbCheckOutHour, cbCheckOutMinute, cbLoaiPhong, finder
        );
        btnTimKiem.addActionListener(controller::handleSearchAction);
        btnDatPhong.addActionListener(controller::handleBookAction);
